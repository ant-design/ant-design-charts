...
<description>**optional** *string* `'funnel' ｜ 'pyramid'` </description>
...
| style     | *ShapeAttrs | false*                                | 文本字体样式配置 |
| formatter | *string | ((datum?: Datum, data?: Data) => string)* | 文本内容格式化   |
...
FUNNEL\_CONVERSATION\_FIELD 为数组，存储漏斗当前和上一项值，例如 \[263, 151], 用户可由此计算转化率，例如:
