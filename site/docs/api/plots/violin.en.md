...
<description>**optional** *boolean | BoxOption*</description>

Whether to show box plot. Default show box plot, you can custom box plot with *BoxOption*. In addition, you could also hide box plot by setting `box: false`.
...
<description>**optional** *'smooth'|'hollow'|'hollow-smooth'*</description>
