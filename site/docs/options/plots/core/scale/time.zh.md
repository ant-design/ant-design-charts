  ...
  const config ={
    "tooltip": {
      "items": [
        {
          "title": "time",
          "items": [       { field: 'start', name: '开盘价' },       { field: 'end', name: '收盘价' },       { field: 'min', name: '最低价' },       { field: 'max', name: '最高价' },     ]
        }
      ]
    },
    "axis": {
    ...
    "style": {
      "stroke": (d) => {     if (d.start === d.end) return '#999999';   },
      "fillOpacity": 1
    },
    "yField": ['start', 'end']
  };
...
```js
{
  "colorField": (d) => {   const trend = Math.sign(d.start - d.end);   return trend > 0 ? '下跌' : trend === 0 ? '不变' : '上涨'; }
}
```
