...
径向坐标系主要负责将数据空间的位置映射到画布空间。而其他视觉属性，例如颜色、大小等，仍然通过相应的比例尺进行映射。关于比例尺的详细信息，请参考[比例尺](/options/plots/core/scale/overview)文档。
...
const Demo = () => {
  ...
  const config ={
    ...
    "yField": "value",
    "xField": "category",
    "data": [     { category: '类别 A', value: 40 },     { category: '类别 B', value: 60 },     { category: '类别 C', value: 80 },   ]
  };
...
const Demo = () => {
  ...
  const config ={
    ...
    "yField": "value",
    "xField": "category",
    "data": [     { category: '类别 A', type: '类型1', value: 40 },     { category: '类别 A', type: '类型2', value: 20 },     { category: '类别 B', type: '类型1', value: 30 },     { category: '类别 B', type: '类型2', value: 50 },     { category: '类别 C', type: '类型1', value: 25 },     { category: '类别 C', type: '类型2', value: 35 },   ]
  };
