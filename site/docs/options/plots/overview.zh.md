...
查看 [Title](/options/plots/component/title) 教程获取更多信息。
...
查看 [Axis](/options/plots/component/axis) 教程获取更多信息。

### 图例 legend

绘制图例，Ant Design Charts 提供了两种图例类型：分类图例（Category Legend）和连续图例（Continuous Legend），分别用于展示分类数据和连续数据。

查看 [Legend](/options/plots/component/legend) 教程获取更多信息。
...
查看 [Scrollbar](/options/plots/component/scrollbar) 教程获取更多信息。
...
查看 [Slider](/options/plots/component/slider) 教程获取更多信息。

### 提示信息 tooltip

当鼠标悬停在某个点上时，会以提示框的形式显示当前点对应的数据的信息，比如该点的值，数据单位等。数据提示框内提示的信息还可以通过格式化函数动态指定。

查看 [Tooltip](/options/plots/component/tooltip) 教程获取更多信息。

### 数据标签 label

Ant Design Charts 中数据标签（Label） 是给图表添加标注的手段之一。

查看 [Label](/options/plots/component/label) 教程获取更多信息。
