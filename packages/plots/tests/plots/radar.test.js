...
import Radar from '../../src/plots/radar';
...
describe('Radar render', () => {
  ...
  it('error template', () => {
    ...
    const testRenderer = create(<Radar {...props} {...chartProps} />);
    const testInstance = testRenderer.root;
  ...
  it('chart render * chartRef with callback', () => {
    ...
    act(() => {
      ReactDOM.render(<Radar {...props} {...chartProps} />, container);
    });
  ...
  it('chartRef with useRef', () => {
    ...
    act(() => {
      ReactDOM.render(<Radar {...props} {...chartProps} ref={refs} />, container);
    });
