...
describe('Stock render', () => {
  ...
  it('classname * loading * style', () => {
    ...
    const testRenderer = create(<Stock {...props} />);
  ...
  it('error template', () => {
    ...
    const testRenderer = create(<Stock {...props} {...chartProps} />);
    const testInstance = testRenderer.root;
  ...
  it.skip('chart render * chartRef with callback', () => {
    ...
    act(() => {
      ReactDOM.render(<Stock {...props} {...chartProps} />, container);
    });
  ...
  it.skip('chartRef with useRef', () => {
    ...
    act(() => {
      ReactDOM.render(<Stock {...props} {...chartProps} ref={refs} />, container);
    });
