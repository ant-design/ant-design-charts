...
import BidirectionalBar from '../../src/plots/bidirectionalBar';
...
describe('BidirectionalBar render', () => {
  ...
  it('chart render * chartRef with callback', () => {
    ...
    act(() => {
      ...
      root.render(<BidirectionalBar {...props} {...chartProps} />);
    });
  ...
  it('chartRef with useRef', () => {
    ...
    act(() => {
      const root = createRoot(container);
      root.render(<BidirectionalBar {...props} {...chartProps} ref={refs} />);
    });
