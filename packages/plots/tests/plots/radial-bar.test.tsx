...
import RadialBar from '../../src/components/radial-bar';
import ChartLoading from '../../src/util/createLoading';
import ErrorBoundary from '../../src/errorBoundary';

const refs = renderHook(() => useRef());

describe('RadialBar render', () => {
  let container;
  const data = [
    {
      date: '2010-01',
  ...
  it('classname * loading * style', () => {
    ...
    const testRenderer = create(<RadialBar {...props} />);
  ...
  it('error template', () => {
    ...
    const testRenderer = create(<RadialBar {...props} {...chartProps} />);
    const testInstance = testRenderer.root;
  ...
  it('chart render * chartRef with callback', () => {
    ...
    act(() => {
      ReactDOM.render(<RadialBar {...props} {...chartProps} />, container);
    });
  ...
  it('chartRef with useRef', () => {
    ...
    act(() => {
      ReactDOM.render(<RadialBar {...props} {...chartProps} ref={refs} />, container);
    });
