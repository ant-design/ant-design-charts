...
describe('Rose render', () => {
  ...
  it('classname * loading * style', () => {
    ...
    const testRenderer = create(<Rose {...props} />);
  ...
  it('error template', () => {
    ...
    const testRenderer = create(<Rose {...props} {...chartProps} />);
    const testInstance = testRenderer.root;
  ...
  it('chart render * chartRef with callback', () => {
    ...
    act(() => {
      ReactDOM.render(<Rose {...props} {...chartProps} />, container);
    });
  ...
  it('chartRef with useRef', () => {
    ...
    act(() => {
      ReactDOM.render(<Rose {...props} {...chartProps} ref={refs} />, container);
    });
