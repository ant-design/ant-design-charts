...
import Line from '../../src/plots/line';
...
describe('Line render', () => {
  ...
  it('error template', () => {
    ...
    const testRenderer = create(<Line {...props} {...chartProps} />);
    const testInstance = testRenderer.root;
  ...
  it('chart render * chartRef with callback', () => {
    ...
    act(() => {
      ReactDOM.render(<Line {...props} {...chartProps} />, container);
    });
  ...
  it('chartRef with useRef', () => {
    ...
    act(() => {
      ReactDOM.render(<Line {...props} {...chartProps} ref={refs} />, container);
    });
