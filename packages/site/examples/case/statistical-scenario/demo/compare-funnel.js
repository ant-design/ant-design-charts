...
import { G2, P } from '@ant-design/charts';
...
const DemoP = () => {
  ...
  function getFillAttrs(cfg) {
    ...
    return { ...defaultAttrs, ...cfg.style, fill: cfg.color, stroke: cfg.color, fillOpacity: cfg.opacity };
  } // 自定义 Shape
      ...
      if (cfg.nextPoints && flag !== 'transformed') {
        ...
        const text = group.addShape('text', {
          attrs: {
            ...
            }${(cfg.data.rate * 100).toFixed(0)}%`,
            fill: {
              'non-transformed': '#009f86',
              increased: '#ff4737',
            }[flag],
            textAlign: 'center',
            textBaseline: 'middle',
  ...
  function adaptor(params) {
    ...
    chart.facet('mirror', {
      ...
      showTitle: false,
      eachView: (view, facet) => {
        const idx = facet.columnIndex; // 关闭所有 axis
...
ReactDOM.render(<DemoP />, document.getElementById('container'));
