...
`Choropleth` 继承基类 [Plot](/zh/docs/api/maps/plot-api)。
...
行政区域分布图的所有配置项，继承自 [Plot options](/zh/docs/api/maps/plot-api#options)。
...
更新显示区域，未开启[钻取功能](/zh/docs/api/maps/plots/choropleth#`options.`drill)时，方法控制地图显示区域。
...
向下钻取方法，配合开启[钻取功能](/zh/docs/api/maps/plots/choropleth#`options.`drill)时，方法控制地图下钻。
...
向上钻取方法，配合开启[钻取功能](/zh/docs/api/maps/plots/choropleth#`options.`drill)时，方法控制地图上钻。上钻行政级别 `level` 可选，默认上钻到当前行政级别的上一层，也可以回到某一行政级别或最高层级别。
...
获取当前已钻取层级数据，配合开启[钻取功能](/zh/docs/api/maps/plots/choropleth#`options.`drill)时使用。
