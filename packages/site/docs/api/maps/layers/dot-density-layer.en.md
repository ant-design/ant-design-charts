...
`DotDensityLayer` 继承 [DotLayer](/zh/docs/api/maps/layers/dot-layer)。
...
继承 [DotLayer 属性](/zh/docs/api/maps/layers/dot-layer#二、属性)。

## 三、方法

继承 [DotLayer 方法](/zh/docs/api/maps/layers/dot-layer#三、方法)。

## 四、事件

继承 [DotLayer 方法](/zh/docs/api/maps/layers/dot-layer#四、事件)。
