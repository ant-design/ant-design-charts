...
var SymbolInstance = /*#__PURE__*/function (_BaseLayer) {
  _inherits(SymbolInstance, _BaseLayer);
  var _super = _createSuper(SymbolInstance);
  function SymbolInstance(_ref) {
    ...
    _this = _super.call(this, SketchFormat.ClassValue.SymbolInstance, {
      width: width,
      y: y,
      x: x,
      height: height
    ...
    _defineProperty(_assertThisInitialized(_this), "shouldBreakMaskChain", false);
