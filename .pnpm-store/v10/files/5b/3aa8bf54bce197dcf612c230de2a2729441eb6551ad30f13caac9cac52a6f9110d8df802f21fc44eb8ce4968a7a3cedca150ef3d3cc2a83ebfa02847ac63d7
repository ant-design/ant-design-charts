 ...
 * 图片处理
 * */
var Bitmap = /*#__PURE__*/function (_BaseLayer) {
  _inherits(Bitmap, _BaseLayer);
  ...
  function Bitmap(_ref) {
    ...
    _this = _super.call(this, SketchFormat.ClassValue.Bitmap, {
      y: y,
      x: x,
      height: height,
      width: width
    ...
    _defineProperty(_assertThisInitialized(_this), "toSketchImageJSON", function () {
      return {
        _class: 'MSJSONOriginalDataReference',
        _ref_class: 'MSImageData',
        _ref: "images/".concat(uuid()),
        data: {
          _data: _this.base64
        },
        sha1: {
