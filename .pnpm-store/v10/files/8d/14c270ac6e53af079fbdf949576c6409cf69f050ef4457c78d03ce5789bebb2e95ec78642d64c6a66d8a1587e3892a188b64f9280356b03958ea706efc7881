...
export type CheckboxStyleProps = GroupStyleProps & PrefixObject<Partial<RectStyleProps>, 'box'> & PrefixObject<Partial<RectStyleProps>, 'checked'> & PrefixObject<TextStyleProps, 'label'> & {
    /**
     * @title 是否选中
