...
const ArcAxisComponent = (options) => {
    ...
    return ({ scales: [scale], value, coordinate, theme }) => {
        ...
        const finalStyle = adaptor(deepMix({}, axisTheme, axisArc, defaultStyle, Object.assign(Object.assign(Object.assign({ type: 'arc', data: labels, titleText: titleContent(title), grid }, (tickLength !== undefined ? { tickLength } : null)), rest), important)));
