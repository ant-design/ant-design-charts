...
export default /*#__PURE__*/(function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(node, options) {
    var group, symbol, symbolLayout, handleSymbol, layerParams, addOverride;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        ...
        case 4:
          ...
          if (options) {
            symbolLayout = options.symbolLayout, handleSymbol = options.handleSymbol, layerParams = options.layerParams;
            if (symbolLayout) {
           ...
           * @param layer
           */
          addOverride = function addOverride(layer) {
           ...
           * 设置一些内置的的 symbol 配置项
           */
          defaultSymbolParamsList.forEach(function (paramsList) {
