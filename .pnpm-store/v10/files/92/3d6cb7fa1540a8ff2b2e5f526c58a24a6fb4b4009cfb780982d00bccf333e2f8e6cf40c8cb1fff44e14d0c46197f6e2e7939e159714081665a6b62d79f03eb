exports.assert						= require.resolve('assert-okam/');
exports.buffer						= require.resolve('buffer-okam/');
...
exports.events						= require.resolve('events-okam/');
exports.fs							= null;
...
exports.punycode					= require.resolve('punycode-okam/');
exports.process						= require.resolve('process-okam/browser.js');
exports.querystring					= require.resolve('querystring-es3-okam/');
...
exports.string_decoder				= require.resolve('string_decoder-okam/');
exports.sys							= require.resolve('util-okam/util.js');
exports.timers						= require.resolve('timers-browserify');
exports.tls							= null;
exports.tty							= require.resolve('tty-browserify');
exports.url							= require.resolve('url-okam/');
exports.util						= require.resolve('util-okam/util.js');
