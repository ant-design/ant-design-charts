 ...
 */
export function elementHoverScale(root, { elements: elementsof, datum, groupKey = (element) => element, scaleFactor = 1.04, shadow = true, shadowColor = 'rgba(0, 0, 0, 0.4)', shadowBlur = 10, shadowOffsetX = 0, shadowOffsetY = 2, zIndex = 10, delay = 60, emitter, state = {}, coordinate, }) {
...
export function ElementHoverScale(_a) {
    ...
    return (context, _contexts, emitter) => {
        ...
        return elementHoverScale(plotArea, Object.assign({ elements: selectG2Elements, datum: datumof, groupKey: createGroup
                ...
                : undefined, state: mergeState(options, ['active']), scaleFactor: scaleFactorParam, shadow,
            shadowColor,
            shadowBlur,
            shadowOffsetX,
            shadowOffsetY,
