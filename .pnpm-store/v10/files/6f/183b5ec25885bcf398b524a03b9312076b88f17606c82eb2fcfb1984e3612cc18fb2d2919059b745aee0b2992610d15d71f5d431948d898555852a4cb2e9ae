...
function _default(faceProjection) {
    ...
    w5.forEach(function(hexagon, j) {
        var _$face = _octahedron.default[j], n = _$face.length, normals = cornerNormals[j] = [];
        for(var i = 0; i < n; ++i){
            w5.push([
                _$face[i],
                hexagon[(i * 2 + 2) % (2 * n)],
    ...
    return (0, _index1.default)(faces[0], face).angle(-30).scale(110.625).center([
        0,
        45
    ]);
}
...
function spherical(cartesian) {
    return [
        (0, _math.atan2)(cartesian[1], cartesian[0]) * _math.degrees,
        (0, _math.asin)((0, _math.max)(-1, (0, _math.min)(1, cartesian[2]))) * _math.degrees
    ];
}
// Converts spherical coordinates (degrees) to 3D Cartesian.
function cartesian(coordinates) {
    var lambda = coordinates[0] * _math.radians, phi = coordinates[1] * _math.radians, cosphi = (0, _math.cos)(phi);
    return [
        cosphi * (0, _math.cos)(lambda),
        cosphi * (0, _math.sin)(lambda),
        (0, _math.sin)(phi)
