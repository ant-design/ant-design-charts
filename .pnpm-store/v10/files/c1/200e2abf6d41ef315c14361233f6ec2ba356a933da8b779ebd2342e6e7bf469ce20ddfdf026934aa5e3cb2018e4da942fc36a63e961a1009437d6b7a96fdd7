...
class Donut extends circle_1.Circle {
    ...
    drawDonutShape(attributes, container) {
        ...
        parsedDonuts.forEach((round, index) => {
            ...
            this.upsert(`round${index}`, g_1.Path, Object.assign(Object.assign(Object.assign({}, style), { d: arc(outerR, innerR, start, start + angle), fill: color }), roundStyle), container);
            start += angle;
        });
    }
