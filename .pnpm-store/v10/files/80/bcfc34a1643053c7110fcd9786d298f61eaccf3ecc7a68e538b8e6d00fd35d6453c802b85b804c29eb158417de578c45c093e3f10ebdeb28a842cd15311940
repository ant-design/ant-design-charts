...
var CategoryItems = /** @class */ (function (_super) {
        ...
        get: function () {
            ...
            var d = data.map(function (datum, index) {
                ...
                return {
                    id: "".concat(id),
                    index: index,
                    style: tslib_1.__assign({ layout: layout, labelText: labelText, valueText: valueText, poptip: poptip, focus: focus, focusMarkerSize: focusMarkerSize, classNamePrefix: classNamePrefix }, Object.fromEntries(Object.entries(style).map(function (_a) {
    ...
    CategoryItems.prototype.renderItems = function (container) {
        ...
        (0, util_2.select)(container)
            ...
            return enter
                ...
                return new item_1.CategoryItem({ style: style }, rest);
            })
    ...
    CategoryItems.prototype.renderNavigator = function (container) {
        ...
        var style = (0, util_2.deepAssign)({ orientation: orientation, classNamePrefix: classNamePrefix }, navStyle);
        var that = this;
        container
