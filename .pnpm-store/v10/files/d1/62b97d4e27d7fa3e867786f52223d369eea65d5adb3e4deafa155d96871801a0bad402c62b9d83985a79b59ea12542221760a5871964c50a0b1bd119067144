...
class Animation {
    ...
    inferStyle(context, options) {
        ...
        if (stage === 'enter') {
            ...
            Object.assign(fromStyle, { opacity: 0 });
            Object.assign(toStyle, { opacity: (_a = (0, cache_1.getCachedStyle)(element, 'opacity')) !== null && _a !== void 0 ? _a : (0, animation_1.inferDefaultValue)('opacity') });
        }
        else if (stage === 'hide') {
            Object.assign(fromStyle, { opacity: (_b = (0, cache_1.getCachedStyle)(element, 'opacity')) !== null && _b !== void 0 ? _b : (0, animation_1.inferDefaultValue)('opacity') });
            Object.assign(toStyle, { opacity: 0 });
        }
