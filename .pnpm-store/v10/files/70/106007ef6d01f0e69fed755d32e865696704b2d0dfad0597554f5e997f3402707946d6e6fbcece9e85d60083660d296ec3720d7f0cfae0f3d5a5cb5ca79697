...
Object.defineProperty(exports, // TODO Use d3-polygon’s polygonContains here for the ring check?
...
function clipRectangle(x0, y0, x1, y1) {
    ...
    return function(stream) {
        var activeStream = stream, bufferStream = (0, _buffer.default)(), segments, polygon, ring, x__, y__, v__, x_, y_, v_, first, clean;
        var clipStream = {
            point: point,
            lineStart: lineStart,
            lineEnd: lineEnd,
        ...
        function polygonEnd() {
            var startInside = polygonInside(), cleanInside = clean && startInside, visible = (segments = (0, _index.merge)(segments)).length;
