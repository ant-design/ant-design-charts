...
```bash
yarn add algoliasearch@5.41.0
# or
npm install algoliasearch@5.41.0
# or
pnpm add algoliasearch@5.41.0
```
...
// for the lite client
<script src="https://cdn.jsdelivr.net/npm/algoliasearch@5.41.0/dist/lite/builds/browser.umd.js"></script>
```
