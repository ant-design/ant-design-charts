 ...
 * the License.
 */
const $require = typeof require !== 'undefined' ? require : createRequire(eval('import.meta.url')); // Used to annotate this plugin's hooks in Tappable invocations
...
export default CrittersWebpackPlugin;
