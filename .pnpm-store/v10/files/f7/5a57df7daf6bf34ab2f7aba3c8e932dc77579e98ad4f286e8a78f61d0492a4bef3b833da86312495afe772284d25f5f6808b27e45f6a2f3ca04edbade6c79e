 ...
 */
export var parseToBitmap = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(node) {
    var _node$getBoundingClie, width, height, y, x, url, svg, bitmap;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        ...
        case 2:
          _node$getBoundingClie = node.getBoundingClientRect(), width = _node$getBoundingClie.width, height = _node$getBoundingClie.height, y = _node$getBoundingClie.y, x = _node$getBoundingClie.x; // 如果解析失败, 则采用提前准备好的错误图片
          url = node.src; // 网络 URL
          if (url.startsWith('//')) {
        ...
        case 10:
          svg = _context.sent;
          svg === null || svg === void 0 ? void 0 : svg.mapBasicInfo(node);
  ...
  return function parseToBitmap(_x) {
