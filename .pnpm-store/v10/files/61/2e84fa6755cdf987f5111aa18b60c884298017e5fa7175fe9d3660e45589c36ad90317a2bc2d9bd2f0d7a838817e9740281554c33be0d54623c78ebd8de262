        ...
        get: function () {
            ...
            var d = data.map(function (datum, index) {
                ...
                return {
                    id: "".concat(id),
                    index: index,
                    style: tslib_1.__assign({ layout: layout, labelText: labelText, valueText: valueText, poptip: poptip, focus: focus, focusMarkerSize: focusMarkerSize }, Object.fromEntries(Object.entries(style).map(function (_a) {
