...
```bash
yarn add @algolia/client-search@5.40.1
# or
npm install @algolia/client-search@5.40.1
# or
pnpm add @algolia/client-search@5.40.1
```
...
```html
<script src="https://cdn.jsdelivr.net/npm/@algolia/client-search@5.40.1/dist/builds/browser.umd.js"></script>
```
