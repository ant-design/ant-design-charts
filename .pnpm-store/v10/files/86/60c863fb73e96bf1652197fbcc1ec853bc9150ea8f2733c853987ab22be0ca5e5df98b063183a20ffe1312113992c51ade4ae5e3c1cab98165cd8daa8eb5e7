...
function _default() {
    var nodes, node, random, alpha, strength = (0, _constant.default)(-30), strengths, distanceMin2 = 1, distanceMax2 = Infinity, theta2 = 0.81;
    function force(_) {
        var i, n = nodes.length, tree = (0, _index.quadtree)(nodes, _simulation.x, _simulation.y).visitAfter(accumulate);
