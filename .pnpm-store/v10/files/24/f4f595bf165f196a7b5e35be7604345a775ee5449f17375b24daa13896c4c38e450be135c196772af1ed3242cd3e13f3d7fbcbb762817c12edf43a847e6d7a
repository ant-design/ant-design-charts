...
```bash
yarn add @algolia/client-personalization@5.41.0
# or
npm install @algolia/client-personalization@5.41.0
# or
pnpm add @algolia/client-personalization@5.41.0
```
...
```html
<script src="https://cdn.jsdelivr.net/npm/@algolia/client-personalization@5.41.0/dist/builds/browser.umd.js"></script>
```
