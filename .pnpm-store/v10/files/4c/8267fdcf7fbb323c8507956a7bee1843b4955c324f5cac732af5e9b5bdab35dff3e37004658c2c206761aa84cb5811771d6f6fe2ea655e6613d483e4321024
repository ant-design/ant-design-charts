...
function _default() {
    var nodes, nDim, node, random, alpha, strength = (0, _constant.default)(-30), strengths, distanceMin2 = 1, distanceMax2 = Infinity, theta2 = 0.81;
    function force(_) {
        var i, n = nodes.length, tree = (nDim === 1 ? (0, _index.binarytree)(nodes, _simulation.x) : nDim === 2 ? (0, _index1.quadtree)(nodes, _simulation.x, _simulation.y) : nDim === 3 ? (0, _index2.octree)(nodes, _simulation.x, _simulation.y, _simulation.z) : null).visitAfter(accumulate);
