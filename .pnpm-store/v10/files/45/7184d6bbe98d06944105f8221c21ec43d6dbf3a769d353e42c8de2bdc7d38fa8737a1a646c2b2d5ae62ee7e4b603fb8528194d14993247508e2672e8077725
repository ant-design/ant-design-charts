...
const LegendContinuous = (options) => {
    ...
    return ({ scales, value, theme, scale }) => {
        ...
        const finalStyle = (0, utils_1.adaptor)(Object.assign({}, legendTheme, Object.assign(Object.assign(Object.assign({ titleText: (0, utils_1.titleContent)(title), labelAlign: 'value', labelFormatter: typeof labelFormatter === 'string'
                ? (d) => (0, d3_format_1.format)(labelFormatter)(d.label)
                : labelFormatter }, inferContinuousConfig(scales, scale, value, options, exports.LegendContinuous, theme)), style), { classNamePrefix: constant_1.G2_CLASS_PREFIX }), rest));
