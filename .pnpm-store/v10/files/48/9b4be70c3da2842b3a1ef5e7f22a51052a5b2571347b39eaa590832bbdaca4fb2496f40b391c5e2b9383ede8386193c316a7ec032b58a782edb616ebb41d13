...
var CategoryItem = /** @class */ (function (_super) {
    ...
    Object.defineProperty(CategoryItem.prototype, "span", {
        get: function () {
            ...
            if (!span)
                return [1, 1];
            var _a = tslib_1.__read((0, util_2.parseSeriesAttr)(span), 2), span1 = _a[0], innerSpan = _a[1];
    ...
    Object.defineProperty(CategoryItem.prototype, "shape", {
        get: function () {
            ...
            var _d = tslib_1.__read(this.spacing, 3), spacing1 = _d[0], spacing2 = _d[1], spacing3 = _d[2];
            if (fullWidth) {
    ...
    Object.defineProperty(CategoryItem.prototype, "spacing", {
        get: function () {
            ...
            if (!spacing)
                return [0, 0, 0];
            var _b = tslib_1.__read((0, util_2.parseSeriesAttr)(spacing), 3), spacing1 = _b[0], spacing2 = _b[1], spacing3 = _b[2];
    ...
    Object.defineProperty(CategoryItem.prototype, "layout", {
        get: function () {
            ...
            var _b = tslib_1.__read(this.spacing, 3), spacing1 = _b[0], spacing2 = _b[1], spacing3 = _b[2];
            return {
                height: height,
                width: width,
    ...
    CategoryItem.prototype.renderMarker = function (container) {
        ...
        (0, util_2.ifShow)(!!marker, this.markerGroup, function () {
            ...
            var newMarker = typeof marker === 'string' ? new marker_1.Marker({ style: { symbol: marker }, className: markerClassName }) : marker();
            if (!oldMarker) {
    ...
    CategoryItem.prototype.renderLabel = function (container) {
        var _a = (0, util_2.subStyleProps)(this.attributes, 'label'), label = _a.text, style = tslib_1.__rest(_a, ["text"]);
        ...
        var labelElement = this.labelGroup.maybeAppendByClassName(CLASS_NAMES.label, function () { return (0, util_2.renderExtDo)(label); });
    ...
    CategoryItem.prototype.renderValue = function (container) {
        var _this = this;
        var _a = (0, util_2.subStyleProps)(this.attributes, 'value'), value = _a.text, style = tslib_1.__rest(_a, ["text"]);
        var classNamePrefix = this.attributes.classNamePrefix;
        ...
        (0, util_2.ifShow)(this.showValue, this.valueGroup, function () {
            ...
            var valueElement = _this.valueGroup.maybeAppendByClassName(CLASS_NAMES.value, function () { return (0, util_2.renderExtDo)(value); });
    ...
    CategoryItem.prototype.createPoptip = function () {
        ...
        var poptipGroup = new poptip_1.Poptip({ style: (0, util_2.deepAssign)(DEFAULT_POPTIP_PROPS, poptipStyle) });
    ...
    CategoryItem.prototype.bindPoptip = function (node) {
        ...
        poptipGroup.bind(node, function () {
            ...
            if (typeof poptip.render === 'function') {
                return { html: poptip.render(tslib_1.__assign(tslib_1.__assign({}, _this.keyFields), { label: label, value: value, color: markerFill })) };
            }
            var html = '';
    ...
    CategoryItem.prototype.renderFocus = function (ctn) {
        ...
        (0, util_2.ifShow)(focus, this.focusGroup, function () {
            ...
            var marker = new marker_1.Marker({
                style: tslib_1.__assign(tslib_1.__assign({}, defaultOptions), { symbol: 'focus' }),
    ...
    CategoryItem.prototype.renderBackground = function (container) {
        ...
        backgroundElement.styles(tslib_1.__assign({ width: width, height: height }, style));
    ...
    CategoryItem.prototype.adjustLayout = function () {
        var _a = this.layout, labelWidth = _a.labelWidth, valueWidth = _a.valueWidth, height = _a.height, _b = tslib_1.__read(_a.position, 4), markerX = _b[0], labelX = _b[1], valueX = _b[2], focusX = _b[3];
