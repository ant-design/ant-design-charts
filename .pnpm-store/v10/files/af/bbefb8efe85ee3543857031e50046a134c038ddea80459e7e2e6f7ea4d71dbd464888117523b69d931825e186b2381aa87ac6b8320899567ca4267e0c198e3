...
var Handle = /** @class */ (function (_super) {
    ...
    Handle.prototype.renderMarker = function (container) {
        var _this = this;
        var _a = this.attributes, orientation = _a.orientation, classNamePrefix = _a.classNamePrefix, _b = _a.markerSymbol, markerSymbol = _b === void 0 ? (0, utils_1.ifHorizontal)(orientation, 'horizontalHandle', 'verticalHandle') : _b;
