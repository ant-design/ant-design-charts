...
A React chart library, based on [g2plot](https://antv-g2plot.gitee.io/zh), current version 0.2.4, refer to [config](https://g2plot.antv.vision/zh/docs/manual/introduction)
